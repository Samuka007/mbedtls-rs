...
impl MbedtlsBuilder {
    ...
    pub fn generate_user_config(&self) -> MbedtlsUserConfig {
        ...
        config
            ...
            .set("SHA3_C", false)
            .set("TIMING_C", false)
            // Trim for ESP32-C6: TLS 1.2 + ECDHE + AES-GCM + SHA-256 only
            .set("SSL_PROTO_TLS1_3", false)
            .set("SSL_TLS1_3_COMPATIBILITY_MODE", false)
            .set("SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_ENABLED", false)
            .set("SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED", false)
            .set("SSL_TLS1_3_KEY_EXCHANGE_MODE_PSK_EPHEMERAL_ENABLED", false)
            .set("SSL_EARLY_DATA", false)
            .set("SSL_PROTO_DTLS", false)
            .set("SSL_DTLS_CONNECTION_ID", false)
            .set("SSL_DTLS_CONNECTION_ID_COMPAT", false)
            .set("SSL_DTLS_ANTI_REPLAY", false)
            .set("SSL_DTLS_HELLO_VERIFY", false)
            .set("SSL_DTLS_SRTP", false)
            .set("SSL_DTLS_CLIENT_PORT_REUSE", false)
            .set("SSL_CACHE_C", false)
            .set("SSL_COOKIE_C", false)
            .set("SSL_TICKET_C", false)
            .set("SSL_SRV_C", false)
            .set("SSL_RENEGOTIATION", false)
            .set("SSL_SESSION_TICKETS", false)
            .set("SSL_ALL_ALERT_MESSAGES", false)
            .set("SSL_ENCRYPT_THEN_MAC", false)
            .set("SSL_MAX_FRAGMENT_LENGTH", false)
            .set("SSL_CONTEXT_SERIALIZATION", false)
            .set("SSL_KEEP_PEER_CERTIFICATE", false)
            .set("SSL_VARIABLE_BUFFER_LENGTH", false)
            .set("CIPHER_MODE_CBC", false)
            .set("CIPHER_MODE_CFB", false)
            .set("CIPHER_MODE_CTR", false)
            .set("CIPHER_MODE_OFB", false)
            .set("CIPHER_MODE_XTS", false)
            .set("CIPHER_PADDING_PKCS7", false)
            .set("CIPHER_PADDING_ONE_AND_ZEROS", false)
            .set("CIPHER_PADDING_ZEROS_AND_LEN", false)
            .set("CIPHER_PADDING_ZEROS", false)
            .set("KEY_EXCHANGE_PSK_ENABLED", false)
            .set("KEY_EXCHANGE_DHE_PSK_ENABLED", false)
            .set("KEY_EXCHANGE_ECDHE_PSK_ENABLED", false)
            .set("KEY_EXCHANGE_RSA_PSK_ENABLED", false)
            .set("KEY_EXCHANGE_RSA_ENABLED", false)
            .set("KEY_EXCHANGE_DHE_RSA_ENABLED", false)
            .set("KEY_EXCHANGE_ECDH_ECDSA_ENABLED", false)
            .set("KEY_EXCHANGE_ECDH_RSA_ENABLED", false)
            .set("KEY_EXCHANGE_ECJPAKE_ENABLED", false)
            .set("ECP_DP_SECP192R1_ENABLED", false)
            .set("ECP_DP_SECP224R1_ENABLED", false)
            .set("ECP_DP_SECP384R1_ENABLED", false)
            .set("ECP_DP_SECP521R1_ENABLED", false)
            .set("ECP_DP_SECP192K1_ENABLED", false)
            .set("ECP_DP_SECP224K1_ENABLED", false)
            .set("ECP_DP_SECP256K1_ENABLED", false)
            .set("ECP_DP_BP256R1_ENABLED", false)
            .set("ECP_DP_BP384R1_ENABLED", false)
            .set("ECP_DP_BP512R1_ENABLED", false)
            .set("ECP_DP_CURVE25519_ENABLED", false)
            .set("ECP_DP_CURVE448_ENABLED", false)
            .set("ECDSA_DETERMINISTIC", false)
            .set("PK_RSA_ALT_SUPPORT", false)
            .set("SELF_TEST", false)
            .set("VERSION_FEATURES", false)
            .set("X509_RSASSA_PSS_SUPPORT", false)
            .set("X509_CRL_PARSE_C", false)
            .set("X509_CSR_PARSE_C", false)
            .set("X509_CREATE_C", false)
            .set("X509_CRT_WRITE_C", false)
            .set("X509_CSR_WRITE_C", false)
            .set("CAMELLIA_C", false)
            .set("ARIA_C", false)
            .set("CCM_C", false)
            .set("CHACHA20_C", false)
            .set("CHACHAPOLY_C", false)
            .set("CMAC_C", false)
            .set("DES_C", false)
            .set("DHM_C", false)
            .set("ECJPAKE_C", false)
            .set("HKDF_C", false)
            .set("HMAC_DRBG_C", false)
            .set("LMS_C", false)
            .set("NIST_KW_C", false)
            .set("MD5_C", false)
            .set("SHA1_C", false)
            ...
            .set("SHA384_C", false)
            .set("SHA512_C", false)
            .set("RIPEMD160_C", false)
            .set("POLY1305_C", false)
            .set("PKCS5_C", false)
            .set("PKCS7_C", false)
            .set("PKCS12_C", false)
            .set("PEM_WRITE_C", false)
